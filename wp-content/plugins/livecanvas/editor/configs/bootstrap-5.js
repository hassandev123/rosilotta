    ...
    properties: {
        ...
        "Animation": {
            "General": {
                ...
                "Mirror": {
                    target: "html",
                    attribute: "data-aos-mirror",
                    widget: "select",
                    class: '', //the prefix
                    values: ['', 'true'],
                    about: "Prevents the animation from dissapearing when scrolling back up the page, so once the animations appear when you scroll down they will not animate on scroll up.",
                },
                "Offset (px)": {
                    target: "html",
